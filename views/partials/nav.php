                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <form method="POST" action="/logout">
                            ...
                            <button class="<?= urlIs('/logout') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium" type="submit">Log out</button>
                        </form>
                    </div>
                    <?php endif; ?>
                </div>
